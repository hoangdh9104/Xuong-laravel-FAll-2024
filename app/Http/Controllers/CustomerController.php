...
class CustomerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(self::PATH_VIEWS . __FUNCTION__, compact('data'));
    }
    ...
    {
        return view(self::PATH_VIEWS . __FUNCTION__);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (!empty($data['avatar']) && Storage::exists($data['avatar'])) {
                Storage::delete($data['avatar']); //  Nếu upload fail thì xóa ảnh trong db
            }
    ...
    {
        return view(self::PATH_VIEWS . __FUNCTION__, compact('customer'));
    }
    ...
    public function forceDestroy(Customer $customer)
    {
        try {
            ...
            if (!empty($customer->avatar) && Storage::exists($customer->avatar)) {
                Storage::delete($customer->avatar); //  Nếu upload fail thì xóa ảnh trong db
            }
